...
export class CadastroClienteService {
  ...
  public get():Observable<Cliente[]> {
    return this.http.get<Cliente[]>(`${enviroment.URL_API}/clientes/cadastro-cliente/carregue`); 
  }
  ...
  public delete(id: number): Observable<void> {
    return this.http.delete<void>(`${enviroment.URL_API}/clientes/cadastro-cliente/delete/${id}`);
  }
